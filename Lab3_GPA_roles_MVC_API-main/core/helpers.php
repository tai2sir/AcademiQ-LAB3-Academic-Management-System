...
/**
 * Helper Functions - Utility functions for templates and controllers.
 */
...
/**
 * Get base path of the application (folder containing index.php).
 */
...
/**
 * Get URL to static asset in public folder.
 */
...
/**
 * Build URL to index.php with query parameters.
 */
...
/**
 * Convert grade letter to grade points (4.0 scale).
 */
...
/**
 * Get list of allowed grade letters.
 */
...
/**
 * Calculate pagination state from total count and current page.
...
/**
 * Generate inline SVG icon from icon library.
 */
